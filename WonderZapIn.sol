...
///@author Zapper
///@notice This contract adds liquidity to PancakeSwap pools on Binance Smart Chain using BNB or any ERC20 Tokens.
...
interface IAsgardDaoBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract AsgardDao_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (IAsgardDaoBondDepository => address) public allowedPairs;
    mapping (IAsgardDaoBondDepository => address) public allowedReserves;
    ...
    constructor()
    {
        ...
        //allowedPairs
        allowedPairs[IAsgardDaoBondDepository(0xc26850686ce755FFb8690EA156E5A6cf03DcBDE1)] = 0xb1D737E74eF2a5Ea9F781C579764Da324B728b8A;
        allowedPairs[IAsgardDaoBondDepository(0xA184AE1A71EcAD20E822cB965b99c287590c4FFe)] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        allowedReserves[IAsgardDaoBondDepository(0x90373E83ae5019F2EffD2471220613b68b455A64)] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
        allowedReserves[IAsgardDaoBondDepository(0xE02B1AA2c4BE73093BE79d763fdFFC0E3cf67318)] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }
    ...
    function ZapInLp(
        ...
        IAsgardDaoBondDepository _bondDepository,
        uint256 _amount,
